<script>
import mask from "$lib/images/Mask group.png"
import bg from "$lib/images/Group 3447.png"

</script>

<main class="bg-white relative">
    <section class="m-28 mx-40 flex gap-5 rounded-2xl bg-gradient-to-tl from-[#080A25] to-[#0a015a]">
<div>
<img src={mask} class=" ml-10 h-[500px]" alt="alt">
</div>
<div>
